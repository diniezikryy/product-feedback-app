  ...
  return (
    <div className="p-6 mb-5 rounded-lg sm:flex sm:flex-row bg-main-primary">
      <div
        ...
        className={
          upvoted
            ? "flex-col items-center justify-center hidden px-2 py-2 mr-10 text-sm font-semibold tracking-wide capitalize rounded-lg cursor-pointer max-h-14 sm:block sm:flex hover:bg-hover-color min-w-[40px] bg-main-secondary"
            : "flex-col items-center justify-center hidden px-2 py-2 mr-10 text-sm font-semibold tracking-wide capitalize rounded-lg cursor-pointer max-h-14 sm:block sm:flex hover:bg-hover-color min-w-[40px] bg-main-secondary"
        }
      >
        <ArrowUp />
        <p
          className={
            upvoted
              ? "mt-2 text-sm text-navy-primary"
              : "mt-2 text-sm text-navy-primary"
          }
        >
          {upvotes}
      ...
      <div className="flex items-center justify-between sm:hidden">
        <div className="flex flex-row items-center hover:bg-hover-color cursor-pointer px-4 py-1.5 text-sm font-semibold tracking-wide capitalize rounded-lg max-w-min  bg-main-secondary">
          <ArrowUp />
          <p className="ml-2 text-sm text-navy-primary">{upvotes}</p>
        </div>
